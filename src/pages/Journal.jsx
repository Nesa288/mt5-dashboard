          ...
          <table className="data-table">
            ...
            <tbody>
              {journalTrades.map(tr => (
                <Fragment key={tr.id}>
                  <tr style={{ cursor: 'pointer' }} onClick={() => setExpandedTrade(expandedTrade === tr.id ? null : tr.id)}>
                    <td>
                    ...
                    <td className="col-jr-hide" style={{ textAlign: 'right', fontFamily: 'Orbitron, monospace', fontSize: 12 }}>{tr.entry.toLocaleString()}</td>
